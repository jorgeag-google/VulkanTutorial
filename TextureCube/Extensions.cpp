...
std::vector<const char*> TextureCubeApp::getRequiredExtensions() {
...
void TextureCubeApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool TextureCubeApp::checkValidationLayerSupport() {
	uint32_t layerCount;
