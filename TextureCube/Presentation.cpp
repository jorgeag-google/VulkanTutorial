...
void TextureCubeApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void TextureCubeApp::recreateSwapChain() {
...
void TextureCubeApp::cleanupSwapChain() {
...
void TextureCubeApp::createSwapChain() {
...
void TextureCubeApp::createImageViews() {
...
VkSurfaceFormatKHR TextureCubeApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR TextureCubeApp::chooseSwapPresentMode(
...
VkExtent2D TextureCubeApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
