...
void MipmapApp::createVertexBuffer() {
...
void MipmapApp::createIndexBuffer() {
...
void MipmapApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t MipmapApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void MipmapApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void MipmapApp::createDepthResources() {
...
VkFormat MipmapApp::findSupportedFormat(const std::vector<VkFormat>& candidates,
...
VkFormat MipmapApp::findDepthFormat() {
...
bool MipmapApp::hasStencilComponent(VkFormat format) {
