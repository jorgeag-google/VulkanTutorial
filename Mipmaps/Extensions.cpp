...
std::vector<const char*> MipmapApp::getRequiredExtensions() {
...
void MipmapApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool MipmapApp::checkValidationLayerSupport() {
	uint32_t layerCount;
