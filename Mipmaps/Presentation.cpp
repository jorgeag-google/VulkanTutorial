...
void MipmapApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void MipmapApp::recreateSwapChain() {
...
void MipmapApp::cleanupSwapChain() {
...
void MipmapApp::createSwapChain() {
...
void MipmapApp::createImageViews() {
...
VkSurfaceFormatKHR MipmapApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR MipmapApp::chooseSwapPresentMode(
...
VkExtent2D MipmapApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
