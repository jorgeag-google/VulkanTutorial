...
void MipmapApp::initWindow() {
	glfwInit();

	glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);

	mWindow = glfwCreateWindow(mWidth, mHeight, "Mipmaps sample", nullptr, nullptr);
...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<MipmapApp*>(glfwGetWindowUserPointer(window));
	app->mFramebufferResized = true;
}

void MipmapApp::initVulkan() {
	createInstance();
	setupDebugMessenger();
	createSurface();
	pickPhysicalDevice();
