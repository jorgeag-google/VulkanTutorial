...
void MipmapApp::createTextureImage() {
...
void MipmapApp::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling,
...
VkCommandBuffer MipmapApp::beginSingleTimeCommands() {
...
void MipmapApp::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void MipmapApp::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
...
void MipmapApp::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void MipmapApp::createTextureSampler() {
...
void MipmapApp::generateMipmaps(VkImage image, VkFormat imageFormat, 
