...
void MipmapApp::pickPhysicalDevice() {
...
SwapChainSupportDetails MipmapApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool MipmapApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void MipmapApp::createLogicalDevice() {
...
bool MipmapApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices MipmapApp::findQueueFamilies(VkPhysicalDevice device) {
