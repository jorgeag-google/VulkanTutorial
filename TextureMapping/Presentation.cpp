...
void TextureMapApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void TextureMapApp::recreateSwapChain() {
...
void TextureMapApp::cleanupSwapChain() {
...
void TextureMapApp::createSwapChain() {
...
void TextureMapApp::createImageViews() {
...
VkSurfaceFormatKHR TextureMapApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR TextureMapApp::chooseSwapPresentMode(
...
VkExtent2D TextureMapApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
