...
VkShaderModule TextureMapApp::createShaderModule(const std::vector<char>& byteCode) {
...
void TextureMapApp::createGraphicsPipeline() {
...
void TextureMapApp::createRenderPass() {
