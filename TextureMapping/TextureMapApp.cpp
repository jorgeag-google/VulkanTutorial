...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<TextureMapApp*>(glfwGetWindowUserPointer(window));
	app->mFramebufferResized = true;
}

void TextureMapApp::initVulkan() {
	createInstance();
	setupDebugMessenger();
	createSurface();
	pickPhysicalDevice();
...
void TextureMapApp::createInstance() {
