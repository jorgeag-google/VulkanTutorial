...
std::vector<const char*> TextureMapApp::getRequiredExtensions() {
...
void TextureMapApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool TextureMapApp::checkValidationLayerSupport() {
	uint32_t layerCount;
