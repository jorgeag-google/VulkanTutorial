...
void DepthBufferApp::createTextureImage() {
...
void DepthBufferApp::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling,
...
VkCommandBuffer DepthBufferApp::beginSingleTimeCommands() {
...
void DepthBufferApp::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void DepthBufferApp::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
...
void DepthBufferApp::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void DepthBufferApp::createTextureImageView() {
	mTextureImageView = createImageView(mTextureImage, VK_FORMAT_R8G8B8A8_SRGB, 
		VK_IMAGE_ASPECT_COLOR_BIT);
}

VkImageView DepthBufferApp::createImageView(VkImage image, VkFormat format, 
...
void DepthBufferApp::createTextureSampler() {
