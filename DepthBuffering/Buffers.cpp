...
void DepthBufferApp::createVertexBuffer() {
...
void DepthBufferApp::createIndexBuffer() {
...
void DepthBufferApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t DepthBufferApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void DepthBufferApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void DepthBufferApp::createDepthResources() {
...
VkFormat DepthBufferApp::findSupportedFormat(const std::vector<VkFormat>& candidates,
...
VkFormat DepthBufferApp::findDepthFormat() {
...
bool DepthBufferApp::hasStencilComponent(VkFormat format) {
