...
void DepthBufferApp::createFramebuffers() {
...
void DepthBufferApp::createCommandPool() {
...
void DepthBufferApp::createCommandBuffers() {
...
void DepthBufferApp::createSyncObjects() {
