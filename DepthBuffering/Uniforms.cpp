...
void DepthBufferApp::createDescriptorSetLayout() {
...
void DepthBufferApp::createUniformBuffers() {
...
void DepthBufferApp::updateUniformBuffer(uint32_t currentImage) {
...
void DepthBufferApp::createDescriptorPool() {
