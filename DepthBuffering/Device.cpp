...
void DepthBufferApp::pickPhysicalDevice() {
...
SwapChainSupportDetails DepthBufferApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool DepthBufferApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void DepthBufferApp::createLogicalDevice() {
...
bool DepthBufferApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices DepthBufferApp::findQueueFamilies(VkPhysicalDevice device) {
