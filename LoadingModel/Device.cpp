...
void LoadModelApp::pickPhysicalDevice() {
...
SwapChainSupportDetails LoadModelApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool LoadModelApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void LoadModelApp::createLogicalDevice() {
...
bool LoadModelApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices LoadModelApp::findQueueFamilies(VkPhysicalDevice device) {
