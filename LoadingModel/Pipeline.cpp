...
VkShaderModule LoadModelApp::createShaderModule(const std::vector<char>& byteCode) {
...
void LoadModelApp::createGraphicsPipeline() {
...
void LoadModelApp::createRenderPass() {
