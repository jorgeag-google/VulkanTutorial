...
std::vector<const char*> LoadModelApp::getRequiredExtensions() {
...
void LoadModelApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool LoadModelApp::checkValidationLayerSupport() {
	uint32_t layerCount;
