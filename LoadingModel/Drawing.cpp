...
void LoadModelApp::createFramebuffers() {
...
void LoadModelApp::createCommandPool() {
...
void LoadModelApp::createCommandBuffers() {
...
void LoadModelApp::createSyncObjects() {
