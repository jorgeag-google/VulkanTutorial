...
void LoadModelApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void LoadModelApp::recreateSwapChain() {
...
void LoadModelApp::cleanupSwapChain() {
...
void LoadModelApp::createSwapChain() {
...
void LoadModelApp::createImageViews() {
...
VkSurfaceFormatKHR LoadModelApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR LoadModelApp::chooseSwapPresentMode(
...
VkExtent2D LoadModelApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
