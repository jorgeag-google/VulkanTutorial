...
void LoadModelApp::createTextureImage() {
...
void LoadModelApp::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling,
...
VkCommandBuffer LoadModelApp::beginSingleTimeCommands() {
...
void LoadModelApp::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void LoadModelApp::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
...
void LoadModelApp::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void LoadModelApp::createTextureImageView() {
	mTextureImageView = createImageView(mTextureImage, VK_FORMAT_R8G8B8A8_SRGB, 
		VK_IMAGE_ASPECT_COLOR_BIT);
}

VkImageView LoadModelApp::createImageView(VkImage image, VkFormat format,
...
void LoadModelApp::createTextureSampler() {
