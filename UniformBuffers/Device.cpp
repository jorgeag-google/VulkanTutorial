...
void UniformBufferApp::pickPhysicalDevice() {
...
SwapChainSupportDetails UniformBufferApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool UniformBufferApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void UniformBufferApp::createLogicalDevice() {
...
bool UniformBufferApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices UniformBufferApp::findQueueFamilies(VkPhysicalDevice device) {
