...
void UniformBufferApp::createFramebuffers() {
...
void UniformBufferApp::createCommandPool() {
...
void UniformBufferApp::createCommandBuffers() {
...
void UniformBufferApp::createSyncObjects() {
...
void UniformBufferApp::drawFrame() {
