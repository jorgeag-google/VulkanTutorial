...
std::vector<const char*> UniformBufferApp::getRequiredExtensions() {
...
void UniformBufferApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool UniformBufferApp::checkValidationLayerSupport() {
	uint32_t layerCount;
