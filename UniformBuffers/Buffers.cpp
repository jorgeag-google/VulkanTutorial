...
void UniformBufferApp::createVertexBuffer() {
...
void UniformBufferApp::createIndexBuffer() {
...
void UniformBufferApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t UniformBufferApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void UniformBufferApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
