...
void UniformBufferApp::initWindow() {
	glfwInit();
...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<UniformBufferApp*>(glfwGetWindowUserPointer(window));
	app->mFramebufferResized = true;
}

void UniformBufferApp::initVulkan() {
	createInstance();
	setupDebugMessenger();
	createSurface();
	pickPhysicalDevice();
...
void UniformBufferApp::mainLoop() {
...
void UniformBufferApp::createInstance() {
