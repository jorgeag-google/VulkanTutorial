...
void UniformBufferApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void UniformBufferApp::recreateSwapChain() {
...
void UniformBufferApp::cleanupSwapChain() {
...
void UniformBufferApp::createSwapChain() {
...
void UniformBufferApp::createImageViews() {
...
VkSurfaceFormatKHR UniformBufferApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR UniformBufferApp::chooseSwapPresentMode(
...
VkExtent2D UniformBufferApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
