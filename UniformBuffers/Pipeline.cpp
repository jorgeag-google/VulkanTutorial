...
VkShaderModule UniformBufferApp::createShaderModule(const std::vector<char>& byteCode) {
...
void UniformBufferApp::createGraphicsPipeline() {
...
void UniformBufferApp::createRenderPass() {
