...
std::vector<const char*> VertexBufferApp::getRequiredExtensions() {
...
void VertexBufferApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool VertexBufferApp::checkValidationLayerSupport() {
	uint32_t layerCount;
