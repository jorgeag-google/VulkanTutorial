...
VkShaderModule VertexBufferApp::createShaderModule(const std::vector<char>& byteCode) {
...
void VertexBufferApp::createGraphicsPipeline() {
	...
	*/
	...
	// Even, when we are not using them we ar required to provide one
...
void VertexBufferApp::createRenderPass() {
