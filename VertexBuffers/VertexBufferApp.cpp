...
void VertexBufferApp::initWindow() {
	glfwInit();
...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<VertexBufferApp*>(glfwGetWindowUserPointer(window));
	app->mFramebufferResized = true;
}

void VertexBufferApp::initVulkan() {
	createInstance();
	setupDebugMessenger();
	createSurface();
	pickPhysicalDevice();
...
void VertexBufferApp::createInstance() {
