...
void VertexBufferApp::pickPhysicalDevice() {
...
SwapChainSupportDetails VertexBufferApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool VertexBufferApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void VertexBufferApp::createLogicalDevice() {
...
bool VertexBufferApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices VertexBufferApp::findQueueFamilies(VkPhysicalDevice device) {
