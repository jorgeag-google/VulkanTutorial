...
void VertexBufferApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void VertexBufferApp::recreateSwapChain() {
...
void VertexBufferApp::cleanupSwapChain() {
...
void VertexBufferApp::createSwapChain() {
...
void VertexBufferApp::createImageViews() {
...
VkSurfaceFormatKHR VertexBufferApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR VertexBufferApp::chooseSwapPresentMode(
...
VkExtent2D VertexBufferApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
