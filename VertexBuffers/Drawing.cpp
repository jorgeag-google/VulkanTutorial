...
void VertexBufferApp::createFramebuffers() {
...
void VertexBufferApp::createCommandPool() {
...
void VertexBufferApp::createCommandBuffers() {
...
void VertexBufferApp::createSyncObjects() {
...
void VertexBufferApp::drawFrame() {
