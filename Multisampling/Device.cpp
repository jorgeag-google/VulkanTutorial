...
void MultisamplingApp::pickPhysicalDevice() {
...
SwapChainSupportDetails MultisamplingApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool MultisamplingApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void MultisamplingApp::createLogicalDevice() {
...
bool MultisamplingApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices MultisamplingApp::findQueueFamilies(VkPhysicalDevice device) {
