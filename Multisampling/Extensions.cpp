...
std::vector<const char*> MultisamplingApp::getRequiredExtensions() {
...
void MultisamplingApp::validateExtensions(const std::vector<const char*>& requiredExt) {
...
bool MultisamplingApp::checkValidationLayerSupport() {
	uint32_t layerCount;
