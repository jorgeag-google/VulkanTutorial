...
void MultisamplingApp::createSurface() {
	if (glfwCreateWindowSurface(mInstance, mWindow, nullptr, &mSurface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void MultisamplingApp::recreateSwapChain() {
...
void MultisamplingApp::cleanupSwapChain() {
...
void MultisamplingApp::createSwapChain() {
...
void MultisamplingApp::createImageViews() {
...
VkSurfaceFormatKHR MultisamplingApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR MultisamplingApp::chooseSwapPresentMode(
...
VkExtent2D MultisamplingApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
