...
void MultisamplingApp::createVertexBuffer() {
...
void MultisamplingApp::createIndexBuffer() {
...
void MultisamplingApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t MultisamplingApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void MultisamplingApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void MultisamplingApp::createDepthResources() {
...
VkFormat MultisamplingApp::findSupportedFormat(const std::vector<VkFormat>& candidates,
...
VkFormat MultisamplingApp::findDepthFormat() {
...
bool MultisamplingApp::hasStencilComponent(VkFormat format) {
	return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}

VkSampleCountFlagBits MultisamplingApp::getMaxUsableSampleCount() {
...
void MultisamplingApp::createColorResources() {
