...
void MultisamplingApp::createTextureImage() {
...
void MultisamplingApp::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, 
...
VkCommandBuffer MultisamplingApp::beginSingleTimeCommands() {
...
void MultisamplingApp::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void MultisamplingApp::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
...
void MultisamplingApp::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void MultisamplingApp::createTextureImageView() {
	mTextureImageView = createImageView(mTextureImage, VK_FORMAT_R8G8B8A8_SRGB, 
		VK_IMAGE_ASPECT_COLOR_BIT, mMipLevels);
}

VkImageView MultisamplingApp::createImageView(VkImage image, VkFormat format,
...
void MultisamplingApp::createTextureSampler() {
...
void MultisamplingApp::generateMipmaps(VkImage image, VkFormat imageFormat,
